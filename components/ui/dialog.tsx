...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[min(92vw,640px)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[1.75rem] border border-white/50 bg-white/85 p-6 shadow-glow backdrop-blur-xl duration-200",
        className
      )}
      {...props}
    >
