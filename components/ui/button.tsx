...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-lg shadow-cyan-900/15 hover:-translate-y-0.5 hover:bg-cyan-700",
        secondary:
          "border border-white/60 bg-white/70 text-slate-900 shadow-glow hover:border-cyan-200 hover:bg-white",
        outline:
          "border border-slate-200 bg-white/80 text-slate-900 hover:border-cyan-300 hover:bg-cyan-50",
